...
fun GrokConfigPage() {
    ...
    val viewModel: GrokConfigViewModel = hiltViewModel()
    val uiState = viewModel.uiState.collectAsStateWithLifecycle()
    val navController = LocalNavHostController.current!!
    val scope = rememberCoroutineScope()
    val context = LocalContext.current
    val parentModel = AIModel.Grok
    ...
    ConfigurationsScaffold(
        ...
        actions = {
            ...
            Button(
                onClick = {
                    scope.launch { viewModel.emitIntent(GrokConfigUIIntent.SaveSettings) }
                ...
                Column(
                    ...
                    PreferenceSwitchWithContainer(
                        ...
                        scope.launch {
                            ...
                            viewModel.emitIntent(GrokConfigUIIntent.ToggleModelEnabled(newCheckedState))
                        }
                    }
                    Title(title = stringResource(R.string.default_model)) {
                        SingleChoiceSegmentedButtonRow(
                            ...
                            subModels.forEachIndexed { index, subModel ->
                                SegmentedButton(
                                    onClick = { scope.launch { viewModel.emitIntent(GrokConfigUIIntent.SelectOption(index)) } },
                    ...
                    Title(title = stringResource(R.string.api_key_settings)) {
                        BaseTextField(
                            ...
                            onValueChange = { scope.launch { viewModel.emitIntent(GrokConfigUIIntent.UpdateApiKey(it)) } },
                    ...
                    Title(title = stringResource(R.string.floating_window_system_instruction_title)) {
                        BaseTextField(
                            ...
                            onValueChange = { scope.launch { viewModel.emitIntent(GrokConfigUIIntent.UpdateFloatingWindowSystemInstruction(it)) } },
                    ...
                    Title(title = stringResource(R.string.parameter_settings)) {
                        Slideable(
                            ...
                            onValueChange = { scope.launch { viewModel.emitIntent(GrokConfigUIIntent.UpdateGrokTemperature(it.toDouble())) } }
                        )
                    }
                }
            }
